...
type Repository interface {
	...
	// it expects an initialized instance be return from an add funcion or an error to bail out
	Add(ctx context.Context,f func() (*account.Account, error)) (uuid.UUID, error)
	...
	Rem(ctx context.Context, i Identifiable, f func(a account.Account) error) error
